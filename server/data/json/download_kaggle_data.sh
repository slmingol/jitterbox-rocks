...
# Check if kaggle.json exists in the correct location
if [ ! -f "/root/.kaggle/kaggle.json" ]; then
    echo "ERROR: kaggle.json not found at /root/.kaggle/kaggle.json!"
    echo ""
    echo "To get your Kaggle API credentials:"
    echo "1. Go to https://www.kaggle.com/YOUR_USERNAME/account"
    echo "2. Scroll to 'API' section"
    echo "3. Click 'Create New API Token'"
    echo "4. Save the downloaded kaggle.json to the project directory"
    echo ""
    exit 1
fi
